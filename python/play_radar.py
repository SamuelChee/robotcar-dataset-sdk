...
parser = argparse.ArgumentParser(
    description="Play back radar data from a given directory"
)
...
for radar_timestamp in radar_timestamps:
    ...
    print("\n\nRadar Resolution: ", radar_resolution, "\n\n")
    ...
    cv2.imshow(title, vis * 2.0)  # The data is doubled to improve visualisation
    cv2.waitKey(1)
